...
const CONFIG = {
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['amanpoddar-dev12/gitprofile', 'amanpoddar-dev12/e-commerce'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  footer: `Made by <a 
      class="text-primary" href="https://github.com/amanpoddar-dev12/"
      target="_blank"
      rel="noreferrer"
    >Aman Poddar</a> ❤️`,
  enablePWA: true,
